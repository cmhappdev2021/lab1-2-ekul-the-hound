...
print("It did not work because it was a constant and not a variable.")
...
print("It does compile. It is different from trying to update a constant because it actually will update instead of just saying error")
